  ...
  return (function () {
  ...
  })()(
    {
      1: [
        ...
        {
          './refs/json-schema-draft-04.json': 2,
          './vocabulary/draft4': 4,
          'ajv/dist/core': 26,
          'ajv/dist/vocabularies/discriminator': 54,
        },
      ],
      2: [
        function (require, module, exports) {
      ...
      3: [
        ...
        { 'ajv/dist/vocabularies/core/ref': 53 },
      ],
      4: [
        function (require, module, exports) {
          'use strict';
        ...
        },
        {
          './core': 3,
          './validation': 5,
          'ajv/dist/vocabularies/applicator': 40,
          'ajv/dist/vocabularies/format': 58,
        },
      ],
      5: [
        function (require, module, exports) {
        ...
        {
          './limitNumber': 6,
          './limitNumberExclusive': 7,
          'ajv/dist/vocabularies/validation/const': 60,
          'ajv/dist/vocabularies/validation/enum': 61,
          'ajv/dist/vocabularies/validation/limitItems': 63,
          'ajv/dist/vocabularies/validation/limitLength': 64,
          'ajv/dist/vocabularies/validation/limitProperties': 66,
          'ajv/dist/vocabularies/validation/multipleOf': 67,
          'ajv/dist/vocabularies/validation/pattern': 68,
          'ajv/dist/vocabularies/validation/required': 69,
          'ajv/dist/vocabularies/validation/uniqueItems': 70,
        },
      ],
      6: [
        function (require, module, exports) {
        ...
        { 'ajv/dist/compile/codegen': 10, 'ajv/dist/core': 26 },
      ],
      7: [
        function (require, module, exports) {
          'use strict';
      ...
      8: [
        ...
        {
          './compile/codegen': 10,
          './compile/ref_error': 15,
          './compile/validate': 23,
          './core': 26,
          './refs/json-schema-draft-07.json': 28,
          './runtime/validation_error': 32,
          './vocabularies/discriminator': 54,
          './vocabularies/draft7': 56,
        },
      ],
      9: [
        function (require, module, exports) {
        ...
        function (require, module, exports) {
          ...
          class ForRange extends For {
            ...
            render(opts) {
              ...
              return (
                `for(${varKind} ${name}=${from}; ${name}<${to}; ${name}++)` + super.render(opts)
              );
            }
            get names() {
      ...
      13: [
        function (require, module, exports) {
          ...
          function resolveSchema(
            ...
            if (
              typeof (schOrRef === null || schOrRef === void 0 ? void 0 : schOrRef.schema) !==
              'object'
            )
              return;
      ...
      16: [
        ...
        { './util': 18, 'fast-deep-equal': 72, 'json-schema-traverse': 77 },
      ],
      17: [
        function (require, module, exports) {
          'use strict';
      ...
      21: [
        function (require, module, exports) {
            ...
            function coerceSpecificType(t) {
              ...
              || (${dataType} === "string" && ${data} && ${data} == +${data} && !(${data} % 1))`,
                ...
                case 'boolean':
                  gen
                    .elseIf(
                      (0, codegen_1._)`${data} === "false" || ${data} === 0 || ${data} === null`,
                    )
                ...
                case 'null':
                  gen.elseIf(
                    (0, codegen_1._)`${data} === "" || ${data} === 0 || ${data} === false`,
                  );
          ...
          function checkDataType(dataType, data, strictNums, correct = DataType.Correct) {
            const EQ =
              correct === DataType.Correct ? codegen_1.operators.EQ : codegen_1.operators.NEQ;
            let cond;
            switch (dataType) {
              case 'null':
        ...
        { '../codegen': 10, '../errors': 12, '../rules': 17, '../util': 18, './applicability': 19 },
      ],
      22: [
        function (require, module, exports) {
          'use strict';
      ...
      24: [
        function (require, module, exports) {
          ...
          function funcKeywordCode(cxt, def) {
            ...
            function reportErrs(errors) {
              var _a;
              gen.if(
                (0, codegen_1.not)((_a = def.valid) !== null && _a !== void 0 ? _a : valid),
                errors,
              );
            }
          }
          ...
          function validateKeywordUsage({ schema, opts, self, errSchemaPath }, def, keyword) {
            /* istanbul ignore if */
            if (
              Array.isArray(def.keyword) ? !def.keyword.includes(keyword) : def.keyword !== keyword
            ) {
              throw new Error('ajv implementation error');
            }
        ...
        { '../../vocabularies/code': 50, '../codegen': 10, '../errors': 12, '../names': 14 },
      ],
      25: [
        function (require, module, exports) {
          'use strict';
      ...
      33: [
        ...
        { '../../compile/codegen': 10, '../../compile/util': 18 },
      ],
      34: [
        function (require, module, exports) {
          'use strict';
    ...
    deps: ${deps}}`, // TODO change to reference
        ...
        { '../../compile/codegen': 10, '../../compile/util': 18, '../code': 50 },
      ],
      39: [
        function (require, module, exports) {
          'use strict';
          ...
          const def = {
            ...
            code(cxt) {
              ...
              function hasDefault(prop) {
                return (
                  it.opts.useDefaults && !it.compositeRule && schema[prop].default !== undefined
                );
              }
      ...
      50: [
        ...
        { '../compile/codegen': 10, '../compile/names': 14, '../compile/util': 18 },
      ],
      51: [
        function (require, module, exports) {
          'use strict';
          ...
          function callRef(cxt, v, sch, $async) {
            ...
            function callAsyncRef() {
              ...
              gen.try(
                () => {
                  gen.code(
                    (0, codegen_1._)`await ${(0, code_1.callValidateCode)(cxt, v, passCxt)}`,
                  );
      ...
      56: [
        ...
        { './applicator': 40, './core': 52, './format': 58, './metadata': 59, './validation': 62 },
      ],
      57: [
        function (require, module, exports) {
          'use strict';
      ...
      60: [
        ...
        { '../../compile/codegen': 10, '../../compile/util': 18, '../../runtime/equal': 29 },
      ],
      61: [
        function (require, module, exports) {
          'use strict';
      ...
      64: [
        ...
        { '../../compile/codegen': 10, '../../compile/util': 18, '../../runtime/ucs2length': 30 },
      ],
      65: [
        function (require, module, exports) {
          'use strict';
        ...
        function (require, module, exports) {
          ...
          const def = {
            ...
            code(cxt) {
              const { keyword, data, schemaCode } = cxt;
              const op =
                keyword === 'maxProperties' ? codegen_1.operators.GT : codegen_1.operators.LT;
      ...
      78: [
        ...
        { ajv: 8, 'ajv-draft-04': 1, 'ajv/lib/refs/json-schema-draft-06.json': 71 },
      ],
    },
    {},
    [78],
