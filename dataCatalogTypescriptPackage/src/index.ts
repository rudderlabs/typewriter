...
export function catalogAddNewEvent(
  ...
  const a = analytics();
  if (a) {
    a.track('catalogAddNewEvent', props || {}, withRudderTyperContext(options), callback);
  }
}
/**
...
export function trackingPlanCreated(
  ...
  const a = analytics();
  if (a) {
    a.track('trackingPlanCreated', props || {}, withRudderTyperContext(options), callback);
  }
}
/**
...
export function trackingPlanConnected(
  ...
  const a = analytics();
  if (a) {
    a.track('trackingPlanConnected', props || {}, withRudderTyperContext(options), callback);
  }
}
/**
...
export function catalogAddNewProperty(
  ...
  const a = analytics();
  if (a) {
    a.track('catalogAddNewProperty', props || {}, withRudderTyperContext(options), callback);
  }
}
/**
...
export function trackingPlanEventsViewed(
  ...
  const a = analytics();
  if (a) {
    a.track('trackingPlanEventsViewed', props || {}, withRudderTyperContext(options), callback);
  }
}
/**
...
export function catalogDeleteEvent(
  ...
  const a = analytics();
  if (a) {
    a.track('catalogDeleteEvent', props || {}, withRudderTyperContext(options), callback);
  }
}
/**
...
export function catalogDeleteProperty(
  ...
  const a = analytics();
  if (a) {
    a.track('catalogDeleteProperty', props || {}, withRudderTyperContext(options), callback);
  }
}
/**
...
export function trackingPlanEdited(
  ...
  const a = analytics();
  if (a) {
    a.track('trackingPlanEdited', props || {}, withRudderTyperContext(options), callback);
  }
}
/**
...
export function clickAddTrackingPlan(
  ...
  const a = analytics();
  if (a) {
    a.track('clickAddTrackingPlan', props || {}, withRudderTyperContext(options), callback);
  }
}
/**
...
export function trackingPlanDraftCreated(
  ...
  const a = analytics();
  if (a) {
    a.track('trackingPlanDraftCreated', props || {}, withRudderTyperContext(options), callback);
  }
}
